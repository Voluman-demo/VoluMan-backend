...
//    }
//
//    public Candidate getCandidate(ID idCandidate, ID recruiterId) {
//        validateRecruiter(recruiterId, volunteerRepository);
...
//
//    @Transactional
//    public void acceptCandidate(ID volId, ID recruiterId) {
//        validateRecruiter(recruiterId, volunteerRepository);
//        Volunteer candidate = (Volunteer) volunteerRepository.findByVolunteerIdAndPosition(volId, Position.CANDIDATE)
//                .orElseThrow(() -> new IllegalArgumentException("Candidate not found"));
//        volunteerService.assignPosition(candidate.getVolunteerId(), Position.VOLUNTEER);
//        userService.register(Optional.of(candidate));
////        volunteerRepository.delete(candidate);
//
//        logService.logCandidate(candidate, EventType.ACCEPT, "Candidate accepted by recruiter " + recruiterId);
//    }
//
//    @Transactional
//    public void refuseCandidate(ID idCandidate, ID recruiterId) {
//        validateRecruiter(recruiterId, volunteerRepository);
//        Volunteer candidate = (Volunteer) volunteerRepository.findByVolunteerIdAndPosition(idCandidate, Position.CANDIDATE)
//                .orElseThrow(() -> new IllegalArgumentException("Candidate not found"));
//        volunteerRepository.delete(candidate);
//        logService.logCandidate(candidate, EventType.REFUSE, "Candidate refused by recruiter " + recruiterId);
//    }
//
//    public Volunteer addCandidate(Volunteer candidate) {
//        if(!isEmailUnique(candidate.getEmail())){
//            throw new IllegalArgumentException("Email address already in use");
//        }
//        logService.logCandidate(candidate, EventType.ADD, "added candidate");
//        return volunteerRepository.save(candidate);
//    }
//
