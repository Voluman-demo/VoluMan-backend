...
public class ActionControllerTest {
    ...
    public void testGetActions_ReturnsOk_WhenActionsListExists() {
        ...
        //TODO when admin/leader
        ResponseEntity<ArrayList<Long>> response = actionController.getAllIds(1L);
    ...
    public void testGetAction_ReturnsOk_WhenActionExists() {
        ...
        when(volunteerRepository.existsById(eq(1L))).thenReturn(true);
        when(volunteerRepository.existsByVolunteerIdAndPosition(eq(1L), eq(Position.CANDIDATE))).thenReturn(false);

        ResponseEntity<Action> response = actionController.getAction(1L, 1L);
    ...
    public void testGetActionDesc_ReturnsOk_WhenActionDescExists() {
        ...
        when(actionService.getAction(1L)).thenReturn(action);
        when(volunteerRepository.existsById(eq(1L))).thenReturn(true);
        when(volunteerRepository.existsByVolunteerIdAndPosition(eq(volunteerId), eq(Position.LEADER))).thenReturn(true);

        ResponseEntity<ArrayList<Version>> response = actionController.getActionDesc(1L, 1L);
    ...
    public void testAddAction_ReturnsCreated_WhenActionAddedSuccessfully() {
        ...
        ResponseEntity<Long> response = actionController.addAction(newAction, 1L);
